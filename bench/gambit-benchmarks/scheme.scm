...
; - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
(define (compile)
  (closure-compile scheme-eval)
  (closure-compile scheme-add-macro)
  (closure-compile scheme-error)
  (closure-compile lst->vector)
  (closure-compile vector->lst)
  (closure-compile push-frame)
  (closure-compile lookup-var)
  (closure-compile macro?)
  (closure-compile push-macro)
  (closure-compile lookup-macro )
  (closure-compile variable)
  (closure-compile shape)
  (closure-compile macro-expand)
  (closure-compile comp-var)
  (closure-compile comp-self-eval)
  (closure-compile comp-quote)
  (closure-compile comp-quasiquote)
  (closure-compile comp-quasiquotation)
  (closure-compile comp-quasiquotation-list)
  (closure-compile unquote-splicing?)
  (closure-compile comp-unquote)
  (closure-compile comp-unquote-splicing)
  (closure-compile comp-set!)
  (closure-compile comp-lambda)
  (closure-compile parms->frame)
  (closure-compile rest-param?)
  (closure-compile comp-body)
  (closure-compile definition-name)
  (closure-compile definition-value)
  (closure-compile comp-if)
  (closure-compile comp-cond)
  (closure-compile comp-cond-aux)
  (closure-compile comp-and)
  (closure-compile comp-and-aux)
  (closure-compile comp-or)
  (closure-compile comp-or-aux)
  (closure-compile comp-case)
  (closure-compile comp-case-aux)
  (closure-compile comp-let)
  (closure-compile bindings->vars)
  (closure-compile bindings->vals)
  (closure-compile comp-let*)
  (closure-compile comp-letrec)
  (closure-compile comp-letrec-aux)
  (closure-compile comp-vals)
  (closure-compile comp-begin)
  (closure-compile comp-sequence)
  (closure-compile comp-sequence-aux)
  (closure-compile comp-do)
  (closure-compile bindings->steps)
  (closure-compile comp-define)
  (closure-compile comp-define-macro)
  (closure-compile comp-combination)
  (closure-compile gen-var-ref)
  (closure-compile gen-rte-ref)
  (closure-compile gen-slot-ref-0)
  (closure-compile gen-slot-ref-1)
  (closure-compile gen-slot-ref-up-2)
  (closure-compile gen-glo-ref)
  (closure-compile gen-cst)
  (closure-compile gen-append-form)
  (closure-compile gen-cons-form)
  (closure-compile gen-vector-form)
  (closure-compile gen-var-set)
  (closure-compile gen-rte-set)
  (closure-compile gen-slot-set-0)
  (closure-compile gen-slot-set-1)
  (closure-compile gen-slot-set-n)
  (closure-compile gen-glo-set)
  (closure-compile gen-lambda-rest)
  (closure-compile gen-lambda-1-rest)
  (closure-compile gen-lambda-2-rest)
  (closure-compile gen-lambda-3-rest)
  (closure-compile gen-lambda-n-rest)
  (closure-compile gen-lambda)
  (closure-compile gen-lambda-0)
  (closure-compile gen-lambda-1)
  (closure-compile gen-lambda-2)
  (closure-compile gen-lambda-3)
  (closure-compile gen-lambda-n)
  (closure-compile gen-sequence)
  (closure-compile gen-when)
  (closure-compile gen-if)
  (closure-compile gen-cond-send)
  (closure-compile gen-and)
  (closure-compile gen-or)
  (closure-compile gen-case)
  (closure-compile gen-case-clause)
  (closure-compile gen-case-else)
  (closure-compile gen-letrec)
  (closure-compile gen-letrec-1)
  (closure-compile gen-letrec-2)
  (closure-compile gen-letrec-3)
  (closure-compile gen-letrec-n)
  (closure-compile gen-macro)
  (closure-compile gen-combination)
  (closure-compile gen-combination-0)
  (closure-compile gen-combination-1)
  (closure-compile gen-combination-2)
  (closure-compile gen-combination-3)
  (closure-compile gen-combination-n)
  (closure-compile scheme-comp)
  (closure-compile scheme-global-var)
  (closure-compile scheme-global-var-ref)
  (closure-compile scheme-global-var-set!)
  (closure-compile def-proc)

...
// core-read
scm_obj_t subr_core_read(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc <= 3) {
    ...
    if (!port_input_pred(port)) {
      if (argc > 0)
        ...
        invalid_object_violation(vm, "core-read", "input port", port, argc, argv);
      return scm_undef;
    }
    if (!port_open_pred(port)) {
      if (argc > 0)
        wrong_type_argument_violation(vm, "read", 0, "opened port", argv[0], argc, argv);
      else
        invalid_object_violation(vm, "core-read", "opened port", port, argc, argv);
      return scm_undef;
    }
    try {
...
scm_obj_t subr_interaction_environment(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 0) {
...
static int fixed_format_floating_point(object_heap_t* heap, char* buf, int buflen, int precision, scm_flonum_t flonum) {
...
// format
scm_obj_t subr_format(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 0) {
...
scm_obj_t subr_top_level_bound_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (SYMBOLP(argv[0])) {
...
scm_obj_t subr_top_level_value(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (SYMBOLP(argv[0])) {
      scm_symbol_t symbol = (scm_symbol_t)argv[0];
      scm_obj_t obj = vm->lookup_current_environment(symbol);
      if (obj != scm_undef) return obj;
#if UNBOUND_GLOC_RETURN_UNSPEC
...
scm_obj_t subr_set_top_level_value(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (SYMBOLP(argv[0])) {
      scm_symbol_t symbol = (scm_symbol_t)argv[0];
...
// run-vmi
scm_obj_t subr_run_vmi(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    vm->m_env = NULL;
    vm->m_pc = argv[0];
...
// weak-mapping?
scm_obj_t subr_weakmapping_pred(VM* vm, int argc, scm_obj_t argv[]) {
...
// make-weak-mapping
scm_obj_t subr_make_weakmapping(VM* vm, int argc, scm_obj_t argv[]) {
...
// weak-mapping-key
scm_obj_t subr_weakmapping_key(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// weak-mapping-value
scm_obj_t subr_weakmapping_value(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
scm_obj_t subr_current_source_comments(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
scm_obj_t subr_current_library_infix(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_current_library_suffix(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_current_primitive_prefix(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_current_temporary_delimiter(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_current_rename_delimiter(VM* vm, int argc, scm_obj_t argv[]) {
...
// backtrace
scm_obj_t subr_backtrace(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// warning-level
scm_obj_t subr_warning_level(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (argv[0] == scm_false || argv[0] == scm_true || (FIXNUMP(argv[0]) && FIXNUM(argv[0]) >= 0)) {
...
scm_obj_t subr_lexical_syntax_version(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (FIXNUMP(argv[0])) {
...
// mutable-literals
scm_obj_t subr_mutable_literals(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// display-backtrace
scm_obj_t subr_display_backtrace(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 0) {
...
scm_obj_t subr_backtrace_line_length(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
scm_obj_t subr_restricted_print_line_length(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (FIXNUMP(argv[0]) && FIXNUM(argv[0]) >= 0) {
...
scm_obj_t subr_record_print_nesting_limit(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (FIXNUMP(argv[0]) && FIXNUM(argv[0]) >= 0) {
...
// collect-notify
scm_obj_t subr_collect_notify(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
scm_obj_t subr_collect_stack_notify(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// collect
scm_obj_t subr_collect(VM* vm, int argc, scm_obj_t argv[]) {
  bool pack = false;
  if (argc == 0 || argc == 1) {
    if (argc == 1) {
      if (BOOLP(argv[0])) {
...
// collect-trip-bytes
scm_obj_t subr_collect_trip_bytes(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (FIXNUMP(argv[0])) {
...
scm_obj_t subr_display_heap_statistics(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 0) {
...
scm_obj_t subr_display_object_statistics(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 0) {
...
// closure-code
scm_obj_t subr_closure_code(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (CLOSUREP(argv[0])) {
...
// closure-arity
scm_obj_t subr_closure_arity(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (CLOSUREP(argv[0])) {
      scm_closure_t closure = (scm_closure_t)argv[0];
...
// decode-flonum
scm_obj_t subr_decode_flonum(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (FLONUMP(argv[0])) {
...
// current-environment
scm_obj_t subr_current_environment(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
scm_obj_t subr_current_macro_environment(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
scm_obj_t subr_current_variable_environment(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (HASHTABLEP(argv[0])) {
...
scm_obj_t subr_current_dynamic_environment(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
scm_obj_t subr_current_dynamic_wind_record(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
scm_obj_t subr_current_exception_handler(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// environment?
scm_obj_t subr_environment_pred(VM* vm, int argc, scm_obj_t argv[]) {
...
// system-environment
scm_obj_t subr_system_environment(VM* vm, int argc, scm_obj_t argv[]) {
...
// make-tuple
scm_obj_t subr_make_tuple(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// tuple->list
scm_obj_t subr_tuple_list(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (TUPLEP(argv[0])) {
...
// escape
scm_obj_t subr_escape(VM* vm, int argc, scm_obj_t argv[]) {
...
// recursion-level
scm_obj_t subr_recursion_level(VM* vm, int argc, scm_obj_t argv[]) {
...
// command-line-shift
scm_obj_t subr_command_line_shift(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (FIXNUMP(argv[0]) && FIXNUM(argv[0]) >= 0) {
      int n = FIXNUM(argv[0]);
...
// tuple
scm_obj_t subr_tuple(VM* vm, int argc, scm_obj_t argv[]) {
...
// tuple?
scm_obj_t subr_tuple_pred(VM* vm, int argc, scm_obj_t argv[]) {
...
// tuple-ref
scm_obj_t subr_tuple_ref(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (TUPLEP(argv[0])) {
      if (FIXNUMP(argv[1])) {
        scm_tuple_t tuple = (scm_tuple_t)argv[0];
...
// tuple-set!
scm_obj_t subr_tuple_set(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 3) {
    if (TUPLEP(argv[0])) {
      if (FIXNUMP(argv[1])) {
        scm_tuple_t tuple = (scm_tuple_t)argv[0];
...
// tuple-length
scm_obj_t subr_tuple_length(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (TUPLEP(argv[0])) {
      scm_tuple_t tuple = (scm_tuple_t)argv[0];
...
// tuple-index
scm_obj_t subr_tuple_index(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc >= 2 && argc <= 4) {
    if (TUPLEP(argv[0])) {
      scm_tuple_t tuple = (scm_tuple_t)argv[0];
...
scm_obj_t subr_string_contains(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc >= 2 && argc <= 6) {
    if (STRINGP(argv[0])) {
...
// symbol-contains
scm_obj_t subr_symbol_contains(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (SYMBOLP(argv[0])) {
      if (STRINGP(argv[1]) || CHARP(argv[1])) {
...
scm_obj_t subr_write_with_shared_structure(VM* vm, int argc, scm_obj_t argv[]) {
  scm_port_t port;
  if (argc == 1) {
    port = vm->m_current_output;
  } else if (argc == 2) {
  ...
  if (port_output_pred(port)) {
    ...
    if (argc > 1)
      wrong_type_argument_violation(vm, "write-with-shared-structure", 1, "opened port", argv[1], argc, argv);
    else
      invalid_object_violation(vm, "write-with-shared-structure", "opened port", port, argc, argv);
    return scm_undef;
  }
  if (argc > 1)
    wrong_type_argument_violation(vm, "write-with-shared-structure", 1, "output port", argv[1], argc, argv);
  else
    invalid_object_violation(vm, "write-with-shared-structure", "output port", port, argc, argv);
  return scm_undef;
}

// read-with-shared-structure (srfi-38)
scm_obj_t subr_read_with_shared_structure(VM* vm, int argc, scm_obj_t argv[]) {
  scm_port_t port;
  if (argc == 0) {
    port = vm->m_current_input;
  } else if (argc == 1) {
  ...
  if (port_input_pred(port)) {
    ...
    if (argc > 0)
      wrong_type_argument_violation(vm, "read-with-shared-structure", 0, "opened port", argv[0], argc, argv);
    else
      invalid_object_violation(vm, "read-with-shared-structure", "opened port", port, argc, argv);
    return scm_undef;
  }
  if (argc > 0)
    wrong_type_argument_violation(vm, "read-with-shared-structure", 0, "input port", argv[0], argc, argv);
  else
    invalid_object_violation(vm, "read-with-shared-structure", "input port", port, argc, argv);
  return scm_undef;
}

// gensym
scm_obj_t subr_gensym(VM* vm, int argc, scm_obj_t argv[]) {
  const char* prefix;
  if (argc < 2) {
    if (argc == 0) {
...
// subr?
scm_obj_t subr_subr_pred(VM* vm, int argc, scm_obj_t argv[]) {
...
// usleep
scm_obj_t subr_usleep(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (FIXNUMP(argv[0])) {
...
scm_obj_t subr_copy_environment_variables(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 3) {
    if (ENVIRONMENTP(argv[0])) {
...
scm_obj_t subr_copy_environment_macros(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 3) {
    if (ENVIRONMENTP(argv[0])) {
      if (ENVIRONMENTP(argv[1])) {
        scm_environment_t from = (scm_environment_t)argv[0];
...
// make-environment
scm_obj_t subr_make_environment(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 0) {
...
scm_obj_t subr_architecture_feature(VM* vm, int argc, scm_obj_t argv[]) {
...
// gethostname
scm_obj_t subr_gethostname(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 0) {
...
scm_obj_t subr_string_uninterned_symbol(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1 || argc == 2) {
    if (STRINGP(argv[0])) {
      scm_string_t string = (scm_string_t)argv[0];
...
// uninterned-symbol?
scm_obj_t subr_uninterned_symbol_pred(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_uninterned_symbol_prefix(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
scm_obj_t subr_uninterned_symbol_suffix(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (UNINTERNEDSYMBOLP(argv[0])) {
      scm_symbol_t symbol = (scm_symbol_t)argv[0];
      int len = HDR_SYMBOL_SIZE(symbol->hdr);
...
// make-uuid
scm_obj_t subr_make_uuid(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 0) {
    char buf[64];
...
// microsecond
scm_obj_t subr_microsecond(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 0) {
    struct timeval tv;
    gettimeofday(&tv, NULL);
...
// microsecond->utc
scm_obj_t subr_microsecond_utc(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1 || argc == 2) {
...
// microsecond->string
scm_obj_t subr_microsecond_string(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1 || argc == 2) {
    if (exact_non_negative_integer_pred(argv[0])) {
      int64_t usec;
      exact_integer_to_int64(argv[0], &usec);
...
// decode-microsecond
scm_obj_t subr_decode_microsecond(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (exact_non_negative_integer_pred(argv[0])) {
      int64_t usec;
      exact_integer_to_int64(argv[0], &usec);
      ...
      struct tm date;
      localtime_r(&sec, &date);
      return make_list(vm->m_heap, 9, MAKEFIXNUM(date.tm_sec), MAKEFIXNUM(date.tm_min), MAKEFIXNUM(date.tm_hour), MAKEFIXNUM(date.tm_mday),
                       MAKEFIXNUM(date.tm_mon), MAKEFIXNUM(date.tm_year), MAKEFIXNUM(date.tm_wday), MAKEFIXNUM(date.tm_yday),
                       MAKEFIXNUM(date.tm_isdst));
    }
...
// encode-microsecond
scm_obj_t subr_encode_microsecond(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 9) {
    for (int i = 0; i < 8; i++) {
...
// time-usage
scm_obj_t subr_time_usage(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 0) {
    struct timeval tv;
    struct rusage ru;
    gettimeofday(&tv, NULL);
    getrusage(RUSAGE_SELF, &ru);
    return make_list(vm->m_heap, 3, make_flonum(vm->m_heap, (double)tv.tv_sec + tv.tv_usec / 1000000.0),
...
// cyclic-object?
scm_obj_t subr_cyclic_object_pred(VM* vm, int argc, scm_obj_t argv[]) {
...
// vector-copy
scm_obj_t subr_vector_copy(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc >= 1 && argc <= 3) {
    if (VECTORP(argv[0])) {
...
static void cmwc_status_init(cmwc_status_t* status, uint64_t seed) {
...
static uint32_t cmwc_random(cmwc_status_t* status) {
  status->i = status->i + 1;
...
scm_obj_t subr_make_cmwc_random_state(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// cmwc-random-u32
scm_obj_t subr_cmwc_random_u32(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (BVECTORP(argv[0])) {
...
// cmwc-random-real
scm_obj_t subr_cmwc_random_real(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (BVECTORP(argv[0])) {
      scm_bvector_t bvect = (scm_bvector_t)argv[0];
      if (bvect->count == sizeof(cmwc_status_t)) {

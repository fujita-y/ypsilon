...
static inline uint16_t LE16(uint8_t* bytes) { return ((uint16_t)bytes[0]) + ((uint16_t)bytes[1] << 8); }

static inline uint16_t BE16(uint8_t* bytes) { return ((uint16_t)bytes[0] << 8) + ((uint16_t)bytes[1]); }
...
// bytevector-s8-ref
scm_obj_t subr_bytevector_s8_ref(VM* vm, int argc, scm_obj_t argv[]) {
...
// bytevector-u8-set!
scm_obj_t subr_bytevector_u8_set(VM* vm, int argc, scm_obj_t argv[]) {
...
// bytevector-s8-set!
scm_obj_t subr_bytevector_s8_set(VM* vm, int argc, scm_obj_t argv[]) {
...
// bytevector-u16-ref
scm_obj_t subr_bytevector_u16_ref(VM* vm, int argc, scm_obj_t argv[]) {
...
// bytevector-s16-ref
scm_obj_t subr_bytevector_s16_ref(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_bytevector_u16_native_ref(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_bytevector_s16_native_ref(VM* vm, int argc, scm_obj_t argv[]) {
...
// bytevector-u16-set!
scm_obj_t subr_bytevector_u16_set(VM* vm, int argc, scm_obj_t argv[]) {
  ...
  if (FIXNUMP(argv[2])) {
    ...
    if (u16 >= 0 && u16 <= UINT16_MAX) {
      if (param.little)
        LE16((uint16_t)u16, param.bytes);
      else
        BE16((uint16_t)u16, param.bytes);
      return scm_unspecified;
    }
  }
  if (exact_integer_pred(argv[2])) {
...
// bytevector-s16-set!
scm_obj_t subr_bytevector_s16_set(VM* vm, int argc, scm_obj_t argv[]) {
  ...
  if (FIXNUMP(argv[2])) {
    ...
    if (s16 >= INT16_MIN && s16 <= INT16_MAX) {
      if (param.little)
        LE16((uint16_t)s16, param.bytes);
      else
        BE16((uint16_t)s16, param.bytes);
      return scm_unspecified;
    }
  }
  if (exact_integer_pred(argv[2])) {
...
scm_obj_t subr_bytevector_u16_native_set(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_bytevector_s16_native_set(VM* vm, int argc, scm_obj_t argv[]) {
...
// bytevector-u32-ref
scm_obj_t subr_bytevector_u32_ref(VM* vm, int argc, scm_obj_t argv[]) {
...
// bytevector-s32-ref
scm_obj_t subr_bytevector_s32_ref(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_bytevector_u32_native_ref(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_bytevector_s32_native_ref(VM* vm, int argc, scm_obj_t argv[]) {
...
// bytevector-u32-set!
scm_obj_t subr_bytevector_u32_set(VM* vm, int argc, scm_obj_t argv[]) {
  mutator_param_t param(4, "bytevector-u32-set!", vm, argc, argv);
  if (param.violation) return scm_undef;
  uint32_t u32;
  if (exact_integer_to_uint32(argv[2], &u32)) {
    if (param.little)
      LE32(u32, param.bytes);
    else
      BE32(u32, param.bytes);
    return scm_unspecified;
  }
  if (exact_integer_pred(argv[2])) {
...
// bytevector-s32-set!
scm_obj_t subr_bytevector_s32_set(VM* vm, int argc, scm_obj_t argv[]) {
  mutator_param_t param(4, "bytevector-s32-set!", vm, argc, argv);
  if (param.violation) return scm_undef;
  int32_t s32;
  if (exact_integer_to_int32(argv[2], &s32)) {
    if (param.little)
      LE32((uint32_t)s32, param.bytes);
    else
      BE32((uint32_t)s32, param.bytes);
    return scm_unspecified;
  }
  if (exact_integer_pred(argv[2])) {
...
scm_obj_t subr_bytevector_u32_native_set(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_bytevector_s32_native_set(VM* vm, int argc, scm_obj_t argv[]) {
...
// bytevector-u64-ref
scm_obj_t subr_bytevector_u64_ref(VM* vm, int argc, scm_obj_t argv[]) {
...
// bytevector-s64-ref
scm_obj_t subr_bytevector_s64_ref(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_bytevector_u64_native_ref(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_bytevector_s64_native_ref(VM* vm, int argc, scm_obj_t argv[]) {
...
// bytevector-u64-set!
scm_obj_t subr_bytevector_u64_set(VM* vm, int argc, scm_obj_t argv[]) {
  mutator_param_t param(8, "bytevector-u64-set!", vm, argc, argv);
  if (param.violation) return scm_undef;
  uint64_t u64;
  if (exact_integer_to_uint64(argv[2], &u64)) {
    if (param.little)
      LE64(u64, param.bytes);
    else
      BE64(u64, param.bytes);
    return scm_unspecified;
  }
  if (exact_integer_pred(argv[2])) {
...
// bytevector-s64-set!
scm_obj_t subr_bytevector_s64_set(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_bytevector_u64_native_set(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_bytevector_s64_native_set(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_bytevector_ieee_single_ref(VM* vm, int argc, scm_obj_t argv[]) {
  union {
    float ieee_single;
    uint8_t bytes[4];
  } datum;
...
scm_obj_t subr_bytevector_ieee_single_native_ref(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_bytevector_ieee_single_set(VM* vm, int argc, scm_obj_t argv[]) {
  union {
    float ieee_single;
    uint8_t bytes[4];
  } datum;
...
scm_obj_t subr_bytevector_ieee_single_native_set(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_bytevector_ieee_double_ref(VM* vm, int argc, scm_obj_t argv[]) {
  union {
    double ieee_double;
    uint8_t bytes[8];
  } datum;
...
scm_obj_t subr_bytevector_ieee_double_native_ref(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_bytevector_ieee_double_set(VM* vm, int argc, scm_obj_t argv[]) {
  union {
    double ieee_double;
    uint8_t bytes[8];
  } datum;
...
scm_obj_t subr_bytevector_ieee_double_native_set(VM* vm, int argc, scm_obj_t argv[]) {
...
// native-endianness
scm_obj_t subr_native_endianness(VM* vm, int argc, scm_obj_t argv[]) {
...
// bytevector?
scm_obj_t subr_bytevector_pred(VM* vm, int argc, scm_obj_t argv[]) {
...
// bytevector-mapping?
scm_obj_t subr_bytevector_mapping_pred(VM* vm, int argc, scm_obj_t argv[]) {
...
// make-bytevector
scm_obj_t subr_make_bytevector(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// bytevector-length
scm_obj_t subr_bytevector_length(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (BVECTORP(argv[0])) {
      scm_bvector_t bvector = (scm_bvector_t)argv[0];
...
// bytevector=?
scm_obj_t subr_bytevector_eq_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (BVECTORP(argv[0])) {
      if (BVECTORP(argv[1])) {
...
// bytevector-fill!
scm_obj_t subr_bytevector_fill(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (BVECTORP(argv[0])) {
      if (FIXNUMP(argv[1])) {
        scm_bvector_t bvector = (scm_bvector_t)argv[0];
...
// bytevector-copy!
scm_obj_t subr_bytevector_destructive_copy(VM* vm, int argc, scm_obj_t argv[]) {
  int source;
  int target;
  int size;
  if (argc == 5) {
...
// bytevector-copy
scm_obj_t subr_bytevector_copy(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (BVECTORP(argv[0])) {
...
// bytevector->u8-list
scm_obj_t subr_bytevector_u8_list(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (BVECTORP(argv[0])) {
      scm_bvector_t bvector = (scm_bvector_t)argv[0];
...
// u8-list->bytevector
scm_obj_t subr_u8_list_bytevector(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// bytevector-u8-ref
scm_obj_t subr_bytevector_u8_ref(VM* vm, int argc, scm_obj_t argv[]) {
...
// string->utf8
scm_obj_t subr_string_utf8(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (STRINGP(argv[0])) {
...
// utf8->string
scm_obj_t subr_utf8_string(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (BVECTORP(argv[0])) {
      scm_bvector_t bvector = (scm_bvector_t)argv[0];
...
// string->utf8/nul
scm_obj_t subr_string_utf8_nul(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (STRINGP(argv[0])) {
      scm_string_t string = (scm_string_t)argv[0];
      int size = string->size;
...
scm_obj_t subr_make_bytevector_mapping(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (FIXNUMP(argv[1])) {
...
static inline scm_obj_t c_u16_ref(const char* subr, VM* vm, int argc, scm_obj_t argv[]) {
  c_accessor_param_t param(2, subr, vm, argc, argv);
  if (param.violation) return scm_undef;
  return MAKEFIXNUM(*(uint16_t*)param.bytes);
}

static inline scm_obj_t c_u32_ref(const char* subr, VM* vm, int argc, scm_obj_t argv[]) {
  c_accessor_param_t param(4, subr, vm, argc, argv);
  if (param.violation) return scm_undef;
  return uint32_to_integer(vm->m_heap, *(uint32_t*)param.bytes);
}

static inline scm_obj_t c_u64_ref(const char* subr, VM* vm, int argc, scm_obj_t argv[]) {
  c_accessor_param_t param(8, subr, vm, argc, argv);
  if (param.violation) return scm_undef;
  return uint64_to_integer(vm->m_heap, *(uint64_t*)param.bytes);
}

static inline scm_obj_t c_s8_ref(const char* subr, VM* vm, int argc, scm_obj_t argv[]) {
  c_accessor_param_t param(1, subr, vm, argc, argv);
  if (param.violation) return scm_undef;
  return MAKEFIXNUM(*(int8_t*)param.bytes);
}

static inline scm_obj_t c_s16_ref(const char* subr, VM* vm, int argc, scm_obj_t argv[]) {
  c_accessor_param_t param(2, subr, vm, argc, argv);
  if (param.violation) return scm_undef;
  return MAKEFIXNUM(*(int16_t*)param.bytes);
}

static inline scm_obj_t c_s32_ref(const char* subr, VM* vm, int argc, scm_obj_t argv[]) {
  c_accessor_param_t param(4, subr, vm, argc, argv);
  if (param.violation) return scm_undef;
  return int32_to_integer(vm->m_heap, *(int32_t*)param.bytes);
}

static inline scm_obj_t c_s64_ref(const char* subr, VM* vm, int argc, scm_obj_t argv[]) {
  c_accessor_param_t param(8, subr, vm, argc, argv);
  if (param.violation) return scm_undef;
  return int64_to_integer(vm->m_heap, *(int64_t*)param.bytes);
}

static inline scm_obj_t c_n8_set(const char* subr, VM* vm, int argc, scm_obj_t argv[]) {
...
static inline scm_obj_t c_n16_set(const char* subr, VM* vm, int argc, scm_obj_t argv[]) {
...
static inline scm_obj_t c_n32_set(const char* subr, VM* vm, int argc, scm_obj_t argv[]) {
...
static inline scm_obj_t c_n64_set(const char* subr, VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_bytevector_c_short_ref(VM* vm, int argc, scm_obj_t argv[]) {
  assert(sizeof(short) == 2);
  return c_s16_ref("bytevector-c-short-ref", vm, argc, argv);
}

// bytevector-c-unsigend-short-ref
scm_obj_t subr_bytevector_c_unsigned_short_ref(VM* vm, int argc, scm_obj_t argv[]) {
  assert(sizeof(unsigned short) == 2);
  return c_u16_ref("bytevector-c-unsigned-short-ref", vm, argc, argv);
}

// bytevector-c-int-ref
scm_obj_t subr_bytevector_c_int_ref(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_bytevector_c_unsigned_int_ref(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_bytevector_c_long_ref(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_bytevector_c_long_long_ref(VM* vm, int argc, scm_obj_t argv[]) {
  assert(sizeof(long long) == 8);
  return c_s64_ref("bytevector-c-long-long-ref", vm, argc, argv);
}

// bytevector-c-unsigend-long-ref
scm_obj_t subr_bytevector_c_unsigned_long_ref(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_bytevector_c_unsigned_long_long_ref(VM* vm, int argc, scm_obj_t argv[]) {
  assert(sizeof(unsigned long long) == 8);
  return c_u64_ref("bytevector-c-unsigned-long-long-ref", vm, argc, argv);
}

// bytevector-c-void*-ref
scm_obj_t subr_bytevector_c_intptr_ref(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_bytevector_c_int8_ref(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_bytevector_c_int16_ref(VM* vm, int argc, scm_obj_t argv[]) { return c_s16_ref("bytevector-c-int16-ref", vm, argc, argv); }

// bytevector-c-int32-ref
scm_obj_t subr_bytevector_c_int32_ref(VM* vm, int argc, scm_obj_t argv[]) { return c_s32_ref("bytevector-c-int32-ref", vm, argc, argv); }

// bytevector-c-int64-ref
scm_obj_t subr_bytevector_c_int64_ref(VM* vm, int argc, scm_obj_t argv[]) { return c_s64_ref("bytevector-c-int64-ref", vm, argc, argv); }

// bytevector-c-uint8-ref
scm_obj_t subr_bytevector_c_uint8_ref(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_bytevector_c_uint16_ref(VM* vm, int argc, scm_obj_t argv[]) { return c_u16_ref("bytevector-c-uint16-ref", vm, argc, argv); }

// bytevector-c-uint32-ref
scm_obj_t subr_bytevector_c_uint32_ref(VM* vm, int argc, scm_obj_t argv[]) { return c_u32_ref("bytevector-c-uint32-ref", vm, argc, argv); }

// bytevector-c-uint64-ref
scm_obj_t subr_bytevector_c_uint64_ref(VM* vm, int argc, scm_obj_t argv[]) { return c_u64_ref("bytevector-c-uint64-ref", vm, argc, argv); }

// bytevector-c-float-ref
scm_obj_t subr_bytevector_c_float_ref(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_bytevector_c_double_ref(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_bytevector_c_short_set(VM* vm, int argc, scm_obj_t argv[]) {
  assert(sizeof(short) == 2);
  return c_n16_set("bytevector-c-short-set!", vm, argc, argv);
}

// bytevector-c-int-set!
scm_obj_t subr_bytevector_c_int_set(VM* vm, int argc, scm_obj_t argv[]) {
  assert(sizeof(int) == 4 || sizeof(int) == 8);
...
scm_obj_t subr_bytevector_c_long_set(VM* vm, int argc, scm_obj_t argv[]) {
  assert(sizeof(long) == 4 || sizeof(long) == 8);
...
scm_obj_t subr_bytevector_c_long_long_set(VM* vm, int argc, scm_obj_t argv[]) {
  assert(sizeof(long long) == 8);
  return c_n64_set("bytevector-c-long-long-set!", vm, argc, argv);
}

// bytevector-c-void*-set!
scm_obj_t subr_bytevector_c_intptr_set(VM* vm, int argc, scm_obj_t argv[]) {
  assert(sizeof(void*) == 4 || sizeof(void*) == 8);
...
scm_obj_t subr_bytevector_c_int8_set(VM* vm, int argc, scm_obj_t argv[]) { return c_n8_set("bytevector-c-int8-set!", vm, argc, argv); }

// bytevector-c-int16-set!
scm_obj_t subr_bytevector_c_int16_set(VM* vm, int argc, scm_obj_t argv[]) { return c_n16_set("bytevector-c-int16-set!", vm, argc, argv); }

// bytevector-c-int32-set!
scm_obj_t subr_bytevector_c_int32_set(VM* vm, int argc, scm_obj_t argv[]) { return c_n32_set("bytevector-c-int32-set!", vm, argc, argv); }

// bytevector-c-int64-set!
scm_obj_t subr_bytevector_c_int64_set(VM* vm, int argc, scm_obj_t argv[]) { return c_n64_set("bytevector-c-int64-set!", vm, argc, argv); }

// bytevector-c-float-set!
scm_obj_t subr_bytevector_c_float_set(VM* vm, int argc, scm_obj_t argv[]) {
...
scm_obj_t subr_bytevector_c_double_set(VM* vm, int argc, scm_obj_t argv[]) {
...
// bytevector-c-strlen
scm_obj_t subr_bytevector_c_strlen(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (BVECTORP(argv[0])) {
      scm_bvector_t bvector = (scm_bvector_t)argv[0];
      int end = bvector->count;
...
scm_obj_t subr_bytevector_pinned_c_void(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (BVECTORP(argv[0])) {
      scm_bvector_t bvector = (scm_bvector_t)argv[0];
      pinning_bytevector(vm->m_heap, bvector);
      return uintptr_to_integer(vm->m_heap, (uintptr_t)bvector->elts);
    }
    wrong_type_argument_violation(vm, "bytevector->pinned-c-void*", 0, "bytevector", argv[0], argc, argv);
    return scm_undef;
  }
  wrong_number_of_arguments_violation(vm, "bytevector->pinned-c-void*", 1, 1, argc, argv);
  return scm_undef;
}
...
#define DEFSUBR(SYM, FUNC) heap->intern_system_subr(SYM, FUNC)
  ...
  DEFSUBR("bytevector->pinned-c-void*", subr_bytevector_pinned_c_void);

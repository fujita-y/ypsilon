...
// weak-core-hashtable?
scm_obj_t subr_weak_core_hashtable_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// make-core-hashtable
scm_obj_t subr_make_core_hashtable(VM* vm, int argc, scm_obj_t argv[]) {
  int nsize = lookup_mutable_hashtable_size(0);
  if (argc == 0) {
...
// core-hashtable?
scm_obj_t subr_core_hashtable_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
scm_obj_t subr_core_hashtable_mutable_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
scm_obj_t subr_core_hashtable_equivalence_function(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (HASHTABLEP(argv[0])) {
      scm_hashtable_t ht = (scm_hashtable_t)argv[0];
      scoped_lock lock(ht->lock);
...
scm_obj_t subr_core_hashtable_hash_function(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (HASHTABLEP(argv[0])) {
      scm_hashtable_t ht = (scm_hashtable_t)argv[0];
      scoped_lock lock(ht->lock);
...
// core-hashtable-set!
scm_obj_t subr_core_hashtable_set(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 3) {
    if (HASHTABLEP(argv[0])) {
      scm_hashtable_t ht = (scm_hashtable_t)argv[0];
...
// core-hashtable-ref
scm_obj_t subr_core_hashtable_ref(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 3) {
    if (HASHTABLEP(argv[0])) {
      scm_hashtable_t ht = (scm_hashtable_t)argv[0];
      scoped_lock lock(ht->lock);
...
scm_obj_t subr_core_hashtable_delete(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (HASHTABLEP(argv[0])) {
      scm_hashtable_t ht = (scm_hashtable_t)argv[0];
      if (!HDR_HASHTABLE_IMMUTABLE(ht->hdr)) {
...
scm_obj_t subr_core_hashtable_clear(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1 || argc == 2) {
...
// core-hashtable-size
scm_obj_t subr_core_hashtable_size(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (HASHTABLEP(argv[0]) || WEAKHASHTABLEP(argv[0])) {
      if (HASHTABLEP(argv[0])) {
        scm_hashtable_t ht = (scm_hashtable_t)argv[0];
...
scm_obj_t subr_core_hashtable_contains_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (HASHTABLEP(argv[0])) {
      scm_hashtable_t ht = (scm_hashtable_t)argv[0];
      scoped_lock lock(ht->lock);
...
// core-hashtable-copy
scm_obj_t subr_core_hashtable_copy(VM* vm, int argc, scm_obj_t argv[]) {
  bool immutable = true;
  if (argc == 1 || argc == 2) {
...
scm_obj_t subr_core_hashtable_alist(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (HASHTABLEP(argv[0])) {
      scm_hashtable_t ht = (scm_hashtable_t)argv[0];
      scoped_lock lock(ht->lock);
...
// string-hash
scm_obj_t subr_string_hash(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (STRINGP(argv[0])) {
...
// symbol-hash
scm_obj_t subr_symbol_hash(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (SYMBOLP(argv[0])) {
...
// equal-hash
scm_obj_t subr_equal_hash(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {

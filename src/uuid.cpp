...
void uuid_v4(char* buf, int bufsize)  // version 4
{
  assert(bufsize > 36);
  ...
  snprintf(buf, bufsize, "%08x-%04x-%04x-%02x%02x-%04x%08x", time_low, time_mid, time_hi_and_version, clock_seq_hi_and_reserved, clock_seq_lo,

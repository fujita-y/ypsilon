...
// quotient
scm_obj_t subr_quotient(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
...
// remainder
scm_obj_t subr_remainder(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (integer_valued_pred(argv[0])) {
      if (integer_valued_pred(argv[1])) {
        if (!n_zero_pred(argv[1])) {
...
// modulo
scm_obj_t subr_modulo(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (integer_valued_pred(argv[0])) {
      if (integer_valued_pred(argv[1])) {
        if (!n_zero_pred(argv[1])) {

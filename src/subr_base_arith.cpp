...
// number?
scm_obj_t subr_number_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// complex?
scm_obj_t subr_complex_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    return number_pred(argv[0]) ? scm_true : scm_false;
  }
...
// real?
scm_obj_t subr_real_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// rational?
scm_obj_t subr_rational_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// integer?
scm_obj_t subr_integer_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// real-valued?
scm_obj_t subr_real_valued_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// rational-valued?
scm_obj_t subr_rational_valued_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// integer-valued?
scm_obj_t subr_integer_valued_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// exact?
scm_obj_t subr_exact_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// inexact?
scm_obj_t subr_inexact_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// inexact
scm_obj_t subr_inexact(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// exact
scm_obj_t subr_exact(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// =
scm_obj_t subr_num_eq(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
...
// <
scm_obj_t subr_num_lt(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
...
// >
scm_obj_t subr_num_gt(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (FIXNUMP(argv[0]) & FIXNUMP(argv[1])) return (FIXNUM(argv[0]) > FIXNUM(argv[1])) ? scm_true : scm_false;
    if (BOTHFLONUMP(argv[0], argv[1])) return (FLONUM(argv[0]) > FLONUM(argv[1])) ? scm_true : scm_false;
    if (real_valued_pred(argv[0])) {
...
// <=
scm_obj_t subr_num_le(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (FIXNUMP(argv[0]) & FIXNUMP(argv[1])) return (FIXNUM(argv[0]) <= FIXNUM(argv[1])) ? scm_true : scm_false;
    if (BOTHFLONUMP(argv[0], argv[1])) return (FLONUM(argv[0]) <= FLONUM(argv[1])) ? scm_true : scm_false;
    if (real_valued_pred(argv[0])) {
...
// >=
scm_obj_t subr_num_ge(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (FIXNUMP(argv[0]) & FIXNUMP(argv[1])) return (FIXNUM(argv[0]) >= FIXNUM(argv[1])) ? scm_true : scm_false;
    if (BOTHFLONUMP(argv[0], argv[1])) return (FLONUM(argv[0]) >= FLONUM(argv[1])) ? scm_true : scm_false;
    if (real_valued_pred(argv[0])) {
...
// zero?
scm_obj_t subr_zero_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// positive?
scm_obj_t subr_positive_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// negative?
scm_obj_t subr_negative_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// odd?
scm_obj_t subr_odd_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// even?
scm_obj_t subr_even_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (integer_valued_pred(argv[0])) {
...
// finite?
scm_obj_t subr_finite_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (real_pred(argv[0])) {
      if (FLONUMP(argv[0])) {
...
// infinite?
scm_obj_t subr_infinite_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (real_pred(argv[0])) {
      if (FLONUMP(argv[0])) {
        scm_flonum_t flonum = (scm_flonum_t)argv[0];
...
// nan?
scm_obj_t subr_nan_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (real_pred(argv[0])) {
      if (FLONUMP(argv[0])) {
        scm_flonum_t flonum = (scm_flonum_t)argv[0];
...
// +
scm_obj_t subr_num_add(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
...
// -
scm_obj_t subr_num_sub(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (FIXNUMP(argv[0]) & FIXNUMP(argv[1])) return intptr_to_integer(vm->m_heap, FIXNUM(argv[0]) - FIXNUM(argv[1]));
    if (BOTHFLONUMP(argv[0], argv[1])) return make_flonum(vm->m_heap, FLONUM(argv[0]) - FLONUM(argv[1]));
    if (number_pred(argv[0])) {
...
// *
scm_obj_t subr_num_mul(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
...
// /
scm_obj_t subr_num_div(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (BOTHFLONUMP(argv[0], argv[1])) return make_flonum(vm->m_heap, FLONUM(argv[0]) / FLONUM(argv[1]));
...
// abs
scm_obj_t subr_abs(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// div
scm_obj_t subr_int_div(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (real_pred(argv[0])) {
...
// div0
scm_obj_t subr_int_div0(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (real_pred(argv[0])) {
      if (n_finite_pred(argv[0])) {
        if (real_pred(argv[1])) {
...
// numerator
scm_obj_t subr_numerator(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (real_valued_pred(argv[0])) {
...
// denominator
scm_obj_t subr_denominator(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (real_valued_pred(argv[0])) {
      bool inexact = FLONUMP(argv[0]);
      scm_obj_t obj = cnvt_to_exact(vm->m_heap, argv[0]);
...
// floor
scm_obj_t subr_floor(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (COMPLEXP(argv[0])) {
...
// ceiling
scm_obj_t subr_ceiling(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (COMPLEXP(argv[0])) {
      scm_complex_t cn = (scm_complex_t)argv[0];
      if (n_zero_pred(cn->imag)) {
...
// truncate
scm_obj_t subr_truncate(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (COMPLEXP(argv[0])) {
      scm_complex_t cn = (scm_complex_t)argv[0];
      if (n_zero_pred(cn->imag)) {
...
// round
scm_obj_t subr_round(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (COMPLEXP(argv[0])) {
      scm_complex_t cn = (scm_complex_t)argv[0];
      if (n_zero_pred(cn->imag)) {
...
// exp
scm_obj_t subr_exp(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// log
scm_obj_t subr_log(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (number_pred(argv[0])) {
...
// sin
scm_obj_t subr_sin(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// cos
scm_obj_t subr_cos(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// tan
scm_obj_t subr_tan(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// asin
scm_obj_t subr_asin(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// acos
scm_obj_t subr_acos(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// atan
scm_obj_t subr_atan(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// sqrt
scm_obj_t subr_sqrt(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// exact-integer-sqrt
scm_obj_t subr_exact_integer_sqrt(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// expt
scm_obj_t subr_expt(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (number_pred(argv[0])) {
      if (number_pred(argv[1])) {
...
// make-rectangular
scm_obj_t subr_make_rectangular(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (real_valued_pred(argv[0])) {
      if (real_valued_pred(argv[1])) {
...
// make-polar
scm_obj_t subr_make_polar(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (real_valued_pred(argv[0])) {
      if (real_valued_pred(argv[1])) {
        scm_obj_t real = COMPLEXP(argv[0]) ? ((scm_complex_t)argv[0])->real : argv[0];
...
// real-part
scm_obj_t subr_real_part(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// imag-part
scm_obj_t subr_imag_part(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// magnitude
scm_obj_t subr_magnitude(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// angle
scm_obj_t subr_angle(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// number->string
scm_obj_t subr_number_to_string(VM* vm, int argc, scm_obj_t argv[]) {
...
// string->number
scm_obj_t subr_string_to_number(VM* vm, int argc, scm_obj_t argv[]) {
  if ((argc == 1) || (argc == 2)) {
    int radix = 0;
    if (argc == 2) {
      if (FIXNUMP(argv[1])) {

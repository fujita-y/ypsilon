...
// flonum?
scm_obj_t subr_flonum_pred(VM* vm, int argc, scm_obj_t argv[]) {
...
// real->flonum
scm_obj_t subr_real_to_flonum(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (real_pred(argv[0])) {
...
// fl<?
scm_obj_t subr_fl_lt(VM* vm, int argc, scm_obj_t argv[]) {
  int bad;
  if (argc == 2) {
    if (BOTHFLONUMP(argv[0], argv[1])) return (FLONUM(argv[0]) < FLONUM(argv[1])) ? scm_true : scm_false;
    bad = FLONUMP(argv[0]) ? 1 : 0;
...
// fl>?
scm_obj_t subr_fl_gt(VM* vm, int argc, scm_obj_t argv[]) {
  int bad;
  if (argc == 2) {
    if (BOTHFLONUMP(argv[0], argv[1])) return (FLONUM(argv[0]) > FLONUM(argv[1])) ? scm_true : scm_false;
    bad = FLONUMP(argv[0]) ? 1 : 0;
...
// fl<=?
scm_obj_t subr_fl_le(VM* vm, int argc, scm_obj_t argv[]) {
  int bad;
  if (argc == 2) {
    if (BOTHFLONUMP(argv[0], argv[1])) return (FLONUM(argv[0]) <= FLONUM(argv[1])) ? scm_true : scm_false;
    bad = FLONUMP(argv[0]) ? 1 : 0;
...
// fl>=?
scm_obj_t subr_fl_ge(VM* vm, int argc, scm_obj_t argv[]) {
  int bad;
  if (argc == 2) {
    if (BOTHFLONUMP(argv[0], argv[1])) return (FLONUM(argv[0]) >= FLONUM(argv[1])) ? scm_true : scm_false;
    bad = FLONUMP(argv[0]) ? 1 : 0;
...
// flinteger?
scm_obj_t subr_fl_integer_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// flzero?
scm_obj_t subr_fl_zero_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// flpositive?
scm_obj_t subr_fl_positive_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (FLONUMP(argv[0])) return (FLONUM(argv[0]) > 0.0) ? scm_true : scm_false;
...
// flnegative?
scm_obj_t subr_fl_negative_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (FLONUMP(argv[0])) return (FLONUM(argv[0]) < 0.0) ? scm_true : scm_false;
...
// flodd?
scm_obj_t subr_fl_odd_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// fleven?
scm_obj_t subr_fl_even_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// flfinite?
scm_obj_t subr_fl_finite_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (FLONUMP(argv[0])) {
...
// flinfinite?
scm_obj_t subr_fl_infinite_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (FLONUMP(argv[0])) {
...
// flnan?
scm_obj_t subr_fl_nan_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (FLONUMP(argv[0])) {
...
// flmax
scm_obj_t subr_fl_max(VM* vm, int argc, scm_obj_t argv[]) {
  int bad;
  if (argc == 2) {
...
// flmin
scm_obj_t subr_fl_min(VM* vm, int argc, scm_obj_t argv[]) {
  int bad;
  if (argc == 2) {
    if (BOTHFLONUMP(argv[0], argv[1])) return (FLONUM(argv[0]) < FLONUM(argv[1])) ? argv[0] : argv[1];
    bad = FLONUMP(argv[0]) ? 1 : 0;
...
// fl+
scm_obj_t subr_fl_add(VM* vm, int argc, scm_obj_t argv[]) {
  int bad;
  if (argc == 2) {
...
// fl*
scm_obj_t subr_fl_mul(VM* vm, int argc, scm_obj_t argv[]) {
  int bad;
  if (argc == 2) {
    if (BOTHFLONUMP(argv[0], argv[1])) return make_flonum(vm->m_heap, FLONUM(argv[0]) * FLONUM(argv[1]));
    bad = FLONUMP(argv[0]) ? 1 : 0;
...
// fl-
scm_obj_t subr_fl_sub(VM* vm, int argc, scm_obj_t argv[]) {
  int bad;
  if (argc == 2) {
    if (BOTHFLONUMP(argv[0], argv[1])) return make_flonum(vm->m_heap, FLONUM(argv[0]) - FLONUM(argv[1]));
    bad = FLONUMP(argv[0]) ? 1 : 0;
...
// fl/
scm_obj_t subr_fl_quotient(VM* vm, int argc, scm_obj_t argv[]) {
  int bad;
  if (argc == 2) {
    if (BOTHFLONUMP(argv[0], argv[1])) return make_flonum(vm->m_heap, FLONUM(argv[0]) / FLONUM(argv[1]));
    bad = FLONUMP(argv[0]) ? 1 : 0;
...
// flabs
scm_obj_t subr_fl_abs(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// fldiv
scm_obj_t subr_fl_div(VM* vm, int argc, scm_obj_t argv[]) {
  int bad;
  if (argc == 2) {
...
// fldiv0
scm_obj_t subr_fl_div0(VM* vm, int argc, scm_obj_t argv[]) {
  int bad;
  if (argc == 2) {
...
// flnumerator
scm_obj_t subr_fl_numerator(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (FLONUMP(argv[0])) {
...
// fldenominator
scm_obj_t subr_fl_denominator(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (FLONUMP(argv[0])) {
      scm_obj_t obj = cnvt_to_exact(vm->m_heap, argv[0]);
...
// flfloor
scm_obj_t subr_fl_floor(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// flceiling
scm_obj_t subr_fl_ceiling(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// fltruncate
scm_obj_t subr_fl_truncate(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// flround
scm_obj_t subr_fl_round(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (FLONUMP(argv[0])) {
...
// flexp
scm_obj_t subr_fl_exp(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// flexpt
scm_obj_t subr_fl_expt(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (FLONUMP(argv[0])) {
      if (FLONUMP(argv[1])) {
...
// fllog
scm_obj_t subr_fl_log(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (FLONUMP(argv[0])) {
      double value = FLONUM(argv[0]);
      if (isinf(value)) {
...
// flsin
scm_obj_t subr_fl_sin(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// flcos
scm_obj_t subr_fl_cos(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// fltan
scm_obj_t subr_fl_tan(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// flasin
scm_obj_t subr_fl_asin(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// flacos
scm_obj_t subr_fl_acos(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// flatan
scm_obj_t subr_fl_atan(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// fixnum->flonum
scm_obj_t subr_fixnum_to_flonum(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// flsqrt
scm_obj_t subr_fl_sqrt(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {

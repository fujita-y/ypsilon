...
// eq?
scm_obj_t subr_eq_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
...
// eqv?
scm_obj_t subr_eqv_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
...
// equal?
scm_obj_t subr_equal_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
...
// procedure?
scm_obj_t subr_procedure_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// unspecified
scm_obj_t subr_unspecified(VM* vm, int argc, scm_obj_t argv[]) {
...
// unspecified?
scm_obj_t subr_unspecified_pred(VM* vm, int argc, scm_obj_t argv[]) {
...
// not
scm_obj_t subr_not(VM* vm, int argc, scm_obj_t argv[]) {
...
// boolean?
scm_obj_t subr_boolean_pred(VM* vm, int argc, scm_obj_t argv[]) {
...
// boolean=?
scm_obj_t subr_boolean_eq_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (BOOLP(argv[0])) {
      if (BOOLP(argv[1])) {
...
// pair?
scm_obj_t subr_pair_pred(VM* vm, int argc, scm_obj_t argv[]) {
...
// cons
scm_obj_t subr_cons(VM* vm, int argc, scm_obj_t argv[]) {
...
// car
scm_obj_t subr_car(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// cdr
scm_obj_t subr_cdr(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// caar
scm_obj_t subr_caar(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// cdar
scm_obj_t subr_cdar(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// cadr
scm_obj_t subr_cadr(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// cddr
scm_obj_t subr_cddr(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// caddr
scm_obj_t subr_caddr(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// null?
scm_obj_t subr_null_pred(VM* vm, int argc, scm_obj_t argv[]) {
...
// list?
scm_obj_t subr_list_pred(VM* vm, int argc, scm_obj_t argv[]) {
...
// list
scm_obj_t subr_list(VM* vm, int argc, scm_obj_t argv[]) {
...
// length
scm_obj_t subr_length(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// append
static scm_obj_t append2(object_heap_t* heap, scm_obj_t lst1, scm_obj_t lst2) {
...
scm_obj_t subr_append(VM* vm, int argc, scm_obj_t argv[]) {
  for (int i = 0; i < argc - 1; i++) {
  ...
  for (int i = argc - 1; i >= 0; i--) {
    if (obj == scm_undef)
      ...
      obj = append2(vm->m_heap, argv[i], obj);
  }
  return obj;
}

// reverse
scm_obj_t subr_reverse(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (listp(argv[0])) {
...
// list-tail
scm_obj_t subr_list_tail(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (PAIRP(argv[0])) {
      if (FIXNUMP(argv[1])) {
...
// list-ref
scm_obj_t subr_list_ref(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (PAIRP(argv[0])) {
      if (FIXNUMP(argv[1])) {
...
// symbol?
scm_obj_t subr_symbol_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// symbol=?
scm_obj_t subr_symbol_eq_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (SYMBOLP(argv[0])) {
      if (SYMBOLP(argv[1])) {
        return (argv[0] == argv[1]) ? scm_true : scm_false;
...
// symbol->string
scm_obj_t subr_symbol_string(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (SYMBOLP(argv[0])) {
...
// string->symbol
scm_obj_t subr_string_symbol(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (STRINGP(argv[0])) {
...
// char?
scm_obj_t subr_char_pred(VM* vm, int argc, scm_obj_t argv[]) {
...
// char->integer
scm_obj_t subr_char_integer(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// integer->char
scm_obj_t subr_integer_char(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// char=?
scm_obj_t subr_char_eq_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (CHARP(argv[0])) {
      if (CHARP(argv[1])) {
...
// char<?
scm_obj_t subr_char_lt_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (CHARP(argv[0])) {
      if (CHARP(argv[1])) {
        return (CHAR(argv[0]) < CHAR(argv[1])) ? scm_true : scm_false;
...
// char>?
scm_obj_t subr_char_gt_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (CHARP(argv[0])) {
      if (CHARP(argv[1])) {
        return (CHAR(argv[0]) > CHAR(argv[1])) ? scm_true : scm_false;
...
// char<=?
scm_obj_t subr_char_le_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (CHARP(argv[0])) {
      if (CHARP(argv[1])) {
        return (CHAR(argv[0]) <= CHAR(argv[1])) ? scm_true : scm_false;
...
// char>=?
scm_obj_t subr_char_ge_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (CHARP(argv[0])) {
      if (CHARP(argv[1])) {
        return (CHAR(argv[0]) >= CHAR(argv[1])) ? scm_true : scm_false;
...
// string?
scm_obj_t subr_string_pred(VM* vm, int argc, scm_obj_t argv[]) {
...
// make-string
scm_obj_t subr_make_string(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// string
scm_obj_t subr_string(VM* vm, int argc, scm_obj_t argv[]) {
  int size = 0;
  for (int i = 0; i < argc; i++) {
    if (CHARP(argv[i])) {
...
// list->string
scm_obj_t subr_list_string(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (listp(argv[0])) {
      scm_obj_t lst = argv[0];
...
// string-length
scm_obj_t subr_string_length(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (STRINGP(argv[0])) {
      scm_string_t string = (scm_string_t)argv[0];
...
// string-ref
scm_obj_t subr_string_ref(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (STRINGP(argv[0])) {
      if (FIXNUMP(argv[1])) {
        scm_string_t string = (scm_string_t)argv[0];
...
// string-set!
scm_obj_t subr_string_set(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 3) {
    if (STRINGP(argv[0])) {
      if (CHARP(argv[2])) {
        if (FIXNUMP(argv[1])) {
...
// string=?
scm_obj_t subr_string_eq_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (STRINGP(argv[0])) {
      if (STRINGP(argv[1])) {
...
// string<?
scm_obj_t subr_string_lt_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (STRINGP(argv[0])) {
      if (STRINGP(argv[1])) {
...
// string>?
scm_obj_t subr_string_gt_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (STRINGP(argv[0])) {
      if (STRINGP(argv[1])) {
        return (string_compare(argv[0], argv[1]) > 0) ? scm_true : scm_false;
...
// string<=?
scm_obj_t subr_string_le_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (STRINGP(argv[0])) {
      if (STRINGP(argv[1])) {
        return (string_compare(argv[0], argv[1]) <= 0) ? scm_true : scm_false;
...
// string>=?
scm_obj_t subr_string_ge_pred(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (STRINGP(argv[0])) {
      if (STRINGP(argv[1])) {
        return (string_compare(argv[0], argv[1]) >= 0) ? scm_true : scm_false;
...
// substring
scm_obj_t subr_substring(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 3) {
    if (STRINGP(argv[0])) {
      scm_string_t string = (scm_string_t)argv[0];
...
// string-append
scm_obj_t subr_string_append(VM* vm, int argc, scm_obj_t argv[]) {
  int size = 0;
  for (int i = 0; i < argc; i++) {
    if (STRINGP(argv[i])) {
...
// string-copy
scm_obj_t subr_string_copy(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (STRINGP(argv[0])) {
      scm_string_t string = (scm_string_t)argv[0];
...
// string-fill!
scm_obj_t subr_string_fill(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (STRINGP(argv[0])) {
      if (CHARP(argv[1])) {
        scm_string_t string = (scm_string_t)argv[0];
...
// vector?
scm_obj_t subr_vector_pred(VM* vm, int argc, scm_obj_t argv[]) {
...
// make-vector
scm_obj_t subr_make_vector(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (FIXNUMP(argv[0]) && FIXNUM(argv[0]) >= 0) {
...
// vector
scm_obj_t subr_vector(VM* vm, int argc, scm_obj_t argv[]) {
...
// vector-length
scm_obj_t subr_vector_length(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (VECTORP(argv[0])) {
...
// vector-ref
scm_obj_t subr_vector_ref(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (VECTORP(argv[0])) {
      scm_vector_t vector = (scm_vector_t)argv[0];
      if (FIXNUMP(argv[1])) {
...
// vector-set!
scm_obj_t subr_vector_set(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 3) {
    if (VECTORP(argv[0])) {
      scm_vector_t vector = (scm_vector_t)argv[0];
      if (FIXNUMP(argv[1])) {
...
// list->vector
scm_obj_t subr_list_vector(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (listp(argv[0])) {
      scm_obj_t lst = argv[0];
      int count = list_length(lst);
...
// vector->list
scm_obj_t subr_vector_list(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
    if (VECTORP(argv[0])) {
      scm_vector_t vector = (scm_vector_t)argv[0];
      int n = vector->count;
...
// vector->fill!
scm_obj_t subr_vector_fill(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (VECTORP(argv[0])) {
      scm_vector_t vector = (scm_vector_t)argv[0];
      int n = vector->count;
...
// values
scm_obj_t subr_values(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) return argv[0];
...
// cxxxr cxxxxr
  ...
  #define DEF_CARS_N_CDRS3(NAME, MC)                                                                    \
    scm_obj_t subr_##NAME(VM* vm, int argc, scm_obj_t argv[]) {                                         \
...
static scm_obj_t n_car_n_cdr(scm_obj_t obj, const int n, const int mc[]) {
  for (int i = 0; i < n; i++) {
    if (PAIRP(obj)) {

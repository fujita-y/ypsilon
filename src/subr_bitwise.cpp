...
// bitwise-bit-count
scm_obj_t subr_bitwise_bit_count(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// bitwise-length
scm_obj_t subr_bitwise_length(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
scm_obj_t subr_bitwise_first_bit_set(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// bitwise-not
scm_obj_t subr_bitwise_not(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 1) {
...
// bitwise-and
scm_obj_t subr_bitwise_and(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
...
// bitwise-ior
scm_obj_t subr_bitwise_ior(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (exact_integer_pred(argv[0])) {
      if (exact_integer_pred(argv[1])) {
...
// bitwise-xor
scm_obj_t subr_bitwise_xor(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (exact_integer_pred(argv[0])) {
      if (exact_integer_pred(argv[1])) {
...
scm_obj_t subr_bitwise_arithmetic_shift(VM* vm, int argc, scm_obj_t argv[]) {
  if (argc == 2) {
    if (exact_integer_pred(argv[0])) {
      if (FIXNUMP(argv[1])) {

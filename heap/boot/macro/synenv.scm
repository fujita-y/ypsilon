...
(define _list (string->uninterned-symbol "_list"))
(define _cons (string->uninterned-symbol "_cons"))
(define _cons* (string->uninterned-symbol "_cons*"))
(define _append (string->uninterned-symbol "_append"))
(define _vector (string->uninterned-symbol "_vector"))
(define _list->vector (string->uninterned-symbol "_list->vector"))
(define _eq? (string->uninterned-symbol "_eq?"))
(define _eqv? (string->uninterned-symbol "_eqv?"))
(define _memq (string->uninterned-symbol "_memq"))
(define _memv (string->uninterned-symbol "_memv"))
(define _call-with-values (string->uninterned-symbol "_call-with-values"))
(define _identifier? (string->uninterned-symbol "_identifiler?"))
(define _make-variable-transformer (string->uninterned-symbol "_make-variable-transformer"))
(define _unspecified (string->uninterned-symbol "_unspecified"))
...
(define private-primitives-environment
  (list
    ...
    (cons _append '|.append|)
    (cons _vector '|.vector|)
    (cons _list->vector '|.list->vector|)
    (cons _eq? '|.eq?|)
    (cons _eqv? '|.eqv?|)
    (cons _memq '|.memq|)
    (cons _memv '|.memv|)
    (cons _call-with-values '|.call-with-values|)
    (cons _identifier? '|.identifier?|)
    (cons _make-variable-transformer '|.make-variable-transformer|)
    (cons _unspecified '|.unspecified|)))

...
(library (srfi srfi-19)
  ...
  (define-record-type date
    (fields
     (mutable nanosecond date-nanosecond tm:set-date-nanosecond!)
  ...
  (define current-process-milliseconds (lambda () 0))

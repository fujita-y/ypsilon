...
(library (ypsilon gdk input)

  (export gdk_input_condition_get_type
  ...
  (define-function unsigned-long gdk_input_condition_get_type ())

  ;; GType gdk_input_mode_get_type (void)
  (define-function unsigned-long gdk_input_mode_get_type ())

  ;; void gdk_input_set_extension_events (GdkWindow* window, gint mask, GdkExtensionMode mode)
  (define-function void gdk_input_set_extension_events (void* int int))

  ;; GType gdk_input_source_get_type (void)
  (define-function unsigned-long gdk_input_source_get_type ())

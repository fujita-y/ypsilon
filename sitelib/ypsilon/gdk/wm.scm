...
(library (ypsilon gdk wm)

  (export gdk_wm_decoration_get_type
  ...
  (define-function unsigned-long gdk_wm_decoration_get_type ())

  ;; GType gdk_wm_function_get_type (void)
  (define-function unsigned-long gdk_wm_function_get_type ())

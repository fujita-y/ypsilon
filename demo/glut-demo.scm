...
(define run
  (lambda ()
    ...
    (glutAddMenuEntry (make-c-string "Icosahedron") 1)
    (glutAddMenuEntry (make-c-string "Octahedron") 2)
    (glutAddMenuEntry (make-c-string "Tetrahedron") 3)
    (glutAddMenuEntry (make-c-string "Dodecahedron") 4)
    (glutAddMenuEntry (make-c-string "Sphere") 5)
    (glutAddMenuEntry (make-c-string "Cone") 6)
    (glutAddMenuEntry (make-c-string "Cube") 7)
    (glutAddMenuEntry (make-c-string "Torus") 8)
    (glutAddMenuEntry (make-c-string "[smooth]") 9)
    (glutAddMenuEntry (make-c-string "[flat]") 10)
    (glutAddMenuEntry (make-c-string "Exit") 11)

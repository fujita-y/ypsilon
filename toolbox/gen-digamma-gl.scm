...
(define re-api-entry (pregexp "^GLAPI\\s+([a-zA-Z0-9*]+)\\s+GLAPIENTRY\\s+([a-zA-Z0-9]+)[(](.*)[)];\\s*$"))
...
(define api-entry (parse-api-entry "toolbox/h/gl.h"))
(define api-const (parse-api-const "toolbox/h/gl.h"))

...
(library (ypsilon pango bidi)

  (export pango_bidi_type_for_unichar
  ...
  (define-function int pango_bidi_type_for_unichar (uint32_t))

  ;; GType pango_bidi_type_get_type (void)
  (define-function unsigned-long pango_bidi_type_get_type ())

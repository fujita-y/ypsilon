...
(library (ypsilon glu)
  ...
  (define lib-name
    (cond (on-linux   "libGLU.so.1")
          ...
          (else
           (assertion-violation #f "can not locate GLU library, unknown operating system"))))
  ...
  (define-function uint8_t gluCheckExtension (void* void*))
  ...
  (define-function void gluQuadricTexture (void* uint8_t))
